@testset "Format" begin
    ...
    @testset "func call" begin
        ...
        @testset "kwarg spacing" begin
            @test format("f(a=1)", Opts(4, true, true, true, true, true, true, true, true, false, true, "none")) == "f(a=1)"
            @test format("f(a = 1)", Opts(4, true, true, true, true, true, true, true, true, false, true, "none")) == "f(a=1)"
            @test format("f(a=1)", Opts(4, true, true, true, true, true, true, true, true, false, true, "single")) == "f(a = 1)"
            @test format("f(a = 1)", Opts(4, true, true, true, true, true, true, true, true, false, true, "single")) == "f(a = 1)"
            @test format("f(a = 1)", Opts(4, true, true, true, true, true, true, true, true, false, true, "off")) == "f(a = 1)"
            @test format("f(a =   1)", Opts(4, true, true, true, true, true, true, true, true, false, true, "off")) == "f(a =   1)"
        end
    end
