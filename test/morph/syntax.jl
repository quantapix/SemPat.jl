...
@testset "syntax" begin
    ...
    @test to_json_sexpr(compose(f, g)) == ["compose",
      ["Hom", "f", ["Ob", "X"], ["Ob", "Y"]],
      ["Hom", "g", ["Ob", "Y"], ["Ob", "Z"]],
    ]
    ...
    @test parse_json_sexpr(FreeCategory, ["Ob", "X"]; symbols=false) == Ob(FreeCategory.Ob, "X")
    @test parse_json_sexpr(FreeCategory, ["Hom", "f", ["Ob", "X"], ["Ob", "Y"]]) == f
    @test parse_json_sexpr(FreeCategory, ["Hom", "f", ["Ob", "X"], ["Ob", "Y"]]; symbols=false) == Hom("f", Ob(FreeCategory.Ob, "X"), Ob(FreeCategory.Ob, "Y"))
