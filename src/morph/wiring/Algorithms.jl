...
category into normal form. Copies and deletions are scodeified as much as
possible.
"""
...
The main difference is the possibility of zero or many function outs.
"""
...
In this scodee but popular heuristic algorithm, the boxes are permuted by
