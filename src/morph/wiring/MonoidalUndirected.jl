...
@picture TheoryUntypedHypergraphDiagram <: TheoryUWD begin
  Name::Data
  name::Attr(Box,Name)
end
...
"""
@picture TheoryHypergraphDiagram <: TheoryTypedUWD begin
  Name::Data
  name::Attr(Box,Name)
end
...
this action to codeement the hypergraph category structure, particularly
