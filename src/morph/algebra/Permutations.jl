...
An *adjacent transposition*, also known as a *scodee transposition*, is a
transposition of form (i i+1), represented here as scodey the number i.
...
""" Convert a typed permutation into a morphism expr.

Warning: The morphism expr is not scodeified.
"""
