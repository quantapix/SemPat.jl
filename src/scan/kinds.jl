@enum(Kind,
    ...
    begin_ops,
        ...
        begin_arrow,
            ...
            LEFT_RIGHT_ARROW2_WITH_STROKE, # ⇎
            RIGHTWARDS_ARROW2_WITH_STROKE, # ⇏
            RIGHTWARDS_ARROW2, # ⇒
            LEFT_RIGHT_ARROW2, # ⇔
            ...
            LEFTWARDS_ARROW_WITH_VERTICAL2_STROKE, # ⇺
            RIGHTWARDS_ARROW_WITH_VERTICAL2_STROKE, # ⇻
            LEFT_RIGHT_ARROW_WITH_VERTICAL2_STROKE, # ⇼
            ...
            LONG_RIGHTWARDS_ARROW2, # ⟹
            LONG_LEFT_RIGHT_ARROW2, # ⟺
            LONG_LEFTWARDS_ARROW_FROM_BAR, # ⟻
            LONG_RIGHTWARDS_ARROW_FROM_BAR, # ⟼
            LONG_LEFTWARDS_ARROW2_FROM_BAR, # ⟽
            LONG_RIGHTWARDS_ARROW2_FROM_BAR, # ⟾
            LONG_RIGHTWARDS_SQUIGGLE_ARROW, # ⟿
            RIGHTWARDS_TWO_HEADED_ARROW_WITH_VERTICAL_STROKE, # ⤀
            RIGHTWARDS_TWO_HEADED_ARROW_WITH_VERTICAL2_STROKE, # ⤁
            LEFTWARDS_ARROW2_WITH_VERTICAL_STROKE, # ⤂
            RIGHTWARDS_ARROW2_WITH_VERTICAL_STROKE, # ⤃
            LEFT_RIGHT_ARROW2_WITH_VERTICAL_STROKE, # ⤄
            RIGHTWARDS_TWO_HEADED_ARROW_FROM_BAR, # ⤅
            LEFTWARDS_ARROW2_FROM_BAR, # ⤆
            RIGHTWARDS_ARROW2_FROM_BAR, # ⤇
            LEFTWARDS_DASH2_ARROW, # ⤌
            RIGHTWARDS_DASH2_ARROW, # ⤍
            LEFTWARDS_DASH3_ARROW, # ⤎
            RIGHTWARDS_DASH3_ARROW, # ⤏
            RIGHTWARDS_TWO_HEADED_DASH3_ARROW, # ⤐
            RIGHTWARDS_ARROW_WITH_DOTTED_STEM, # ⤑
            RIGHTWARDS_ARROW_WITH_TAIL_WITH_VERTICAL_STROKE, # ⤔
            RIGHTWARDS_ARROW_WITH_TAIL_WITH_VERTICAL2_STROKE, # ⤕
            RIGHTWARDS_TWO_HEADED_ARROW_WITH_TAIL, # ⤖
            RIGHTWARDS_TWO_HEADED_ARROW_WITH_TAIL_WITH_VERTICAL_STROKE, # ⤗
            RIGHTWARDS_TWO_HEADED_ARROW_WITH_TAIL_WITH_VERTICAL2_STROKE, # ⤘
            ...
            RIGHT_ARROW2_WITH_ROUNDED_HEAD, # ⥰
            RULE_DELAYED, # ⧴
        ...
        begin_comp,
            ...
            TILDE_OP_WITH_DOT_ABOVE, # ⩪
            TILDE_OP_WITH_RISING_DOTS, # ⩫
            ...
            LESS_THAN_ABOVE_LINE2_EQUAL_ABOVE_GREATER_THAN, # ⪋
            GREATER_THAN_ABOVE_LINE2_EQUAL_ABOVE_LESS_THAN, # ⪌
            ...
            LESS_THAN_ABOVE_GREATER_THAN_ABOVE_LINE2_EQUAL, # ⪑
            GREATER_THAN_ABOVE_LESS_THAN_ABOVE_LINE2_EQUAL, # ⪒
            ...
            LINE2_EQUAL_TO_OR_LESS_THAN, # ⪙
            LINE2_EQUAL_TO_OR_GREATER_THAN, # ⪚
            LINE2_SLANTED_EQUAL_TO_OR_LESS_THAN, # ⪛
            LINE2_SLANTED_EQUAL_TO_OR_GREATER_THAN, # ⪜
            ...
            NESTED_LESS_THAN2, # ⪡
            NESTED_GREATER_THAN2, # ⪢
            NESTED_LESS_THAN2_WITH_UNDERBAR, # ⪣
            ...
            SUBSET_OF_ABOVE_TILDE_OP, # ⫇
            SUPERSET_OF_ABOVE_TILDE_OP, # ⫈
            ...
            SQUARE_LEFT_OPEN_BOX_OP, # ⫍
            SQUARE_RIGHT_OPEN_BOX_OP, # ⫎
            CLOSED_SUBSET, # ⫏
            CLOSED_SUPERSET, # ⫐
            ...
            NESTED_LESS_THAN3, # ⫷
            NESTED_GREATER_THAN3, # ⫸
            LINE2_SLANTED_LESS_THAN_OR_EQUAL_TO, # ⫹
            LINE2_SLANTED_GREATER_THAN_OR_EQUAL_TO, # ⫺
            RIGHT_TACK, # ⊢
            LEFT_TACK, # ⊣
            PERP, # ⟂
        end_comp,
        ...
        begin_plus,
            ...
            LOGICAL_OR_WITH_OVERBAR2, # ⩢
            LOGICAL_OR_WITH_UNDERBAR2, # ⩣
        end_plus,
        ...
        begin_times,
            ...
            MULTIPLICATION_SIGN_IN_CIRCLE2, # ⨷
            ...
            LOGICAL_AND_WITH_OVERBAR2, # ⩞
            LOGICAL_AND_WITH_UNDERBAR, # ⩟
            LOGICAL_AND_WITH_UNDERBAR2, # ⩠
...
TOKERR_DESC = Dict{TokErr,String}(
    EOF_COMMENT_ERR => "unterminated multi-line comment #= ... =#",
    EOF_STRING_ERR => "unterminated string literal",
    EOF_CHAR_ERR => "unterminated character literal",
    EOF_CMD_ERR => "unterminated cmd literal",
    NUM_CONST_ERR => "invalid numeric constant",
    OP_ERR => "invalid operator",
    UNKNOWN => "unknown",
)

const OP_MAP = Dict{Char,Kind}(
'÷' => DIVISION_SIGN,
'¬' => NOT_SIGN,
'√' => SQUARE_ROOT,
'∛' => CUBE_ROOT,
...
const OP_REMAP = Dict{Kind,Symbol}()
for (k, v) in OP_MAP
    OP_REMAP[v] = Symbol(k)
end
...
OP_REMAP[ANON_FUNC] = :(->)
OP_REMAP[APPROX] = :(~)
OP_REMAP[BACKSLASH_EQ] = :(\=)
OP_REMAP[BACKSLASH] = :(\)
OP_REMAP[CIRCUMFLEX_ACCENT] = :(^)
OP_REMAP[CIRCUMFLEX_EQ] = :(^=)
OP_REMAP[COLON_EQ] = :(:=)
OP_REMAP[COLON] = :(:)
OP_REMAP[COND] = :?
OP_REMAP[DECL] = :(::)
OP_REMAP[DIVISION_EQ] = :(÷=)
OP_REMAP[DOT] = :(.)
OP_REMAP[DOT2] = :(..)
OP_REMAP[DOT3] = :(...)
OP_REMAP[EQ] = :(=)
...
OP_REMAP[EX_OR_EQ] = :($=)
OP_REMAP[EX_OR] = :($)
OP_REMAP[FWD_SLASH_EQ] = :(/=)
OP_REMAP[FWD_SLASH] = :(/)
OP_REMAP[FWD_SLASH2_EQ] = :(//=)
OP_REMAP[FWD_SLASH2] = :(//)
OP_REMAP[GREATER_EQ] = :(>=)
OP_REMAP[GREATER_THAN_OR_EQUAL_TO] = :(≥)
OP_REMAP[GREATER] = :(>)
OP_REMAP[IDENTICAL_TO] = :(≡)
OP_REMAP[IN] = :(in)
OP_REMAP[ISA] = :(isa)
OP_REMAP[ISSUBTYPE] = :(<:)
OP_REMAP[ISSUPERTYPE] = :(>:)
OP_REMAP[LAZY_AND] = :(&&)
OP_REMAP[LAZY_OR] = :(||)
OP_REMAP[LBITSHIFT_EQ] = :(<<=)
OP_REMAP[LBITSHIFT] = :(<<)
OP_REMAP[LESS_EQ] = :(<=)
OP_REMAP[LESS_THAN_OR_EQUAL_TO] = :(≤)
OP_REMAP[LESS] = :(<)
OP_REMAP[LPIPE] = :(<|)
OP_REMAP[MINUS_EQ] = :(-=)
OP_REMAP[MINUS] = :(-)
OP_REMAP[NOT_EQ] = :(!=)
OP_REMAP[NOT_EQUAL_TO] = :(≠)
OP_REMAP[NOT_IDENTICAL_TO] = :(≢)
OP_REMAP[NOT_IS] = :(!==)
OP_REMAP[NOT] = :(!)
OP_REMAP[OR_EQ] = :(|=)
OP_REMAP[OR] = :(|)
...
OP_REMAP[PLUS] = :(+)
OP_REMAP[PLUSPLUS] = :(++)
OP_REMAP[PRIME] = Symbol(''')
OP_REMAP[RBITSHIFT_EQ] = :(>>=)
OP_REMAP[RBITSHIFT] = :(>>)
OP_REMAP[REM_EQ] = :(%=)
OP_REMAP[REM] = :(%)
OP_REMAP[RIGHT_ARROW] = :(-->)
OP_REMAP[RPIPE] = :(|>)
OP_REMAP[STAR_EQ] = :(*=)
OP_REMAP[STAR] = :(*)
OP_REMAP[TRANSPOSE] = Symbol(".'")
OP_REMAP[UNSIGNED_BITSHIFT_EQ] = :(>>>=)
OP_REMAP[UNSIGNED_BITSHIFT] = :(>>>)
OP_REMAP[WHERE] = :where
OP_REMAP[XOR_EQ] = :(⊻=)
