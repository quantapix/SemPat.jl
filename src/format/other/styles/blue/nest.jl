function n_tupleh!(bs::BlueStyle, fst::FST, s::Formatter)
    style = getstyle(bs)
...
@inline n_call!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_curly!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_macrocall!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_ref!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_braces!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_vect!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_parameters!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_invisbrackets!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
@inline n_bracescat!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)
# @inline n_vcat!(bs::BlueStyle, fst::FST, s::Formatter) = n_tupleh!(bs, fst, s)

function n_conditionalopcall!(bs::BlueStyle, fst::FST, s::Formatter)
    style = getstyle(bs)
...
function n_binaryopcall!(bs::BlueStyle, fst::FST, s::Formatter)
