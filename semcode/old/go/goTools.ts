...
export function getImportPathWithVersion(tool: Tool, version: semver.SemVer | string | undefined, goVersion: GoVersion): string {
...
export function getConfiguredTools(goVersion: GoVersion, goConfig: { [key: string]: any }, goplsConfig: { [key: string]: any }): Tool[] {
  ...
  for (const name of ['gocode', 'gopkgs', 'go-outline', 'go-symbols', 'guru', 'gorename', 'gotests', 'gomodifytags', 'impl', 'fillstruct', 'goplay', 'godoctor']) {
    maybeAddTool(name);
  }
...
export function goplsStaticcheckEnabled(goConfig: { [key: string]: any }, goplsConfig: { [key: string]: any }): boolean {
