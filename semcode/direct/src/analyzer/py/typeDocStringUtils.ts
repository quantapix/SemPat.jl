import { ClassDeclaration, Declaration, DeclarationBase, DeclarationType, FunctionDeclaration, isClassDeclaration, isFunctionDeclaration } from '../analyzer/declaration';
import * as ParseTreeUtils from '../analyzer/parseTreeUtils';
import { isStubFile, SourceMapper } from '../analyzer/sourceMapper';
import { ClassType, FunctionType, isClass, isFunction, isOverloadedFunction, ModuleType, OverloadedFunctionType, Type } from '../analyzer/types';
...
export function getClassDocString(classType: ClassType, resolvedDecl: Declaration | undefined, sourceMapper: SourceMapper) {
  ...
  if (!docString && resolvedDecl && isClassDeclaration(resolvedDecl)) {
    ...
    if (!docString && resolvedDecl && isStubFile(resolvedDecl.path) && resolvedDecl.type === DeclarationType.Class) {
