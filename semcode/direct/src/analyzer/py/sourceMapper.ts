...
export class SourceMapper {
  ...
  private _findSpecialBuiltInClassDeclarations(stubDecl: SpecialBuiltInClassDeclaration, recursiveDeclCache = new Set<string>()) {
  ...
  private _findFunctionOrTypeAliasDeclarations(stubDecl: FunctionDeclaration, recursiveDeclCache = new Set<string>()): ClassOrFunctionOrVariableDeclaration[] {
  ...
  private _findVariableDeclarations(stubDecl: VariableDeclaration, recursiveDeclCache = new Set<string>()): VariableDeclaration[] {
  ...
  private _findParameterDeclarations(stubDecl: ParameterDeclaration): ParameterDeclaration[] {
    ...
    for (const functionStubDecl of functionStubDecls) {
      for (const functionDecl of this._findFunctionOrTypeAliasDeclarations(functionStubDecl as FunctionDeclaration, recursiveDeclCache)) {
        result.push(
  ...
  private _findFieldDeclarationsByName(sourceFile: SourceFile, className: string, variableName: string, recursiveDeclCache: Set<string>): VariableDeclaration[] {
  ...
  private _findMethodDeclarationsByName(sourceFile: SourceFile, className: string, functionName: string, recursiveDeclCache: Set<string>): ClassOrFunctionOrVariableDeclaration[] {
  ...
  private _findVariableDeclarationsByName(sourceFile: SourceFile, variableName: string, recursiveDeclCache: Set<string>): VariableDeclaration[] {
  ...
  private _findFunctionDeclarationsByName(sourceFile: SourceFile, functionName: string, recursiveDeclCache: Set<string>): ClassOrFunctionOrVariableDeclaration[] {
    const result: ClassOrFunctionOrVariableDeclaration[] = [];
  ...
  private _findClassDeclarations(sourceFile: SourceFile, className: string, parentNode: ParseNode, recursiveDeclCache: Set<string>): ClassOrFunctionOrVariableDeclaration[] {
    const result: ClassOrFunctionOrVariableDeclaration[] = [];
  ...
  private _addVariableDeclarations(decl: Declaration, result: ClassOrFunctionOrVariableDeclaration[], recursiveDeclCache: Set<string>) {
    if (isVariableDeclaration(decl)) {
      if (isStubFile(decl.path)) {
  ...
  private _addClassOrFunctionDeclarations(decl: Declaration, result: ClassOrFunctionOrVariableDeclaration[], recursiveDeclCache: Set<string>) {
  ...
  private _addClassTypeDeclarations(originated: string, type: ClassType, result: ClassOrFunctionOrVariableDeclaration[], recursiveDeclCache: Set<string>) {
