...
export function createTypeEvaluatorWithTracker(importLookup: ImportLookup, evaluatorOptions: EvaluatorOptions, logger: LogTracker, printer?: TracePrinter) {
  ...
  const withTracker: TypeEvaluator = {
    ...
    getDeclaredTypeForExpression: (n) => run('getDeclaredTypeForExpression', () => typeEvaluator.getDeclaredTypeForExpression(n), n),
    ...
    getTypeFromIterable: (t, a, e) => run('getTypeFromIterable', () => typeEvaluator.getTypeFromIterable(t, a, e), t),
    getTypeFromIterator: (t, a, e) => run('getTypeFromIterator', () => typeEvaluator.getTypeFromIterator(t, a, e), t),
    getTypedDictMembersForClass: (c, a) => run('getTypedDictMembersForClass', () => typeEvaluator.getTypedDictMembersForClass(c, a), c),
    ...
    getFunctionInferredReturnType: (t) => run('getFunctionInferredReturnType', () => typeEvaluator.getFunctionInferredReturnType(t), t),
    ...
    bindFunctionToClassOrObject: (b, m) => run('bindFunctionToClassOrObject', () => typeEvaluator.bindFunctionToClassOrObject(b, m), m),
    getCallSignatureInfo: (n, i, a) => run('getCallSignatureInfo', () => typeEvaluator.getCallSignatureInfo(n, i, a), n),
    getTypeAnnotationForParameter: (n, p) => run('getTypeAnnotationForParameter', () => typeEvaluator.getTypeAnnotationForParameter(n, p), n),
    ...
    canAssignProtocolClassToSelf: (d, s) => run('canAssignProtocolClassToSelf', () => typeEvaluator.canAssignProtocolClassToSelf(d, s)),
