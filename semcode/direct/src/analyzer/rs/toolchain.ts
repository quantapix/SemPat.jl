...
export class Cargo {
  ...
  private runCargo(cargoArgs: string[], onStdoutJson: (obj: any) => void, onStderrString: (data: string) => void): Promise<number> {
...
export const getPathForExecutable = memoize((executableName: 'cargo' | 'rustc' | 'rustup'): string => {
  {
